...
describe('angucomplete', function() {
  ...
  describe('Render', function() {
    ...
    it('should render input element with given id plus _value', function() {
      var element = angular.element('<div angucomplete id="ex1" selectedobject="selectedCountry" titlefield="name" searchstr="searchString"></div>');
    ...
    it('should render planceholder string', function() {
      var element = angular.element('<div angucomplete id="ex1" placeholder="Search countries" selectedobject="selectedCountry" localdata="countries" searchfields="name" titlefield="name" searchstr="searchString"/>');
      $scope.selectedCountry = null;
      $compile(element)($scope);
      $scope.$digest();
  ...
  describe('Local data', function() {
    ...
    it('should show search results after 1 letter is entered with minlength being set to 1', function() {
      var element = angular.element('<div angucomplete id="ex1" placeholder="Search countries" selectedobject="selectedCountry" localdata="countries" searchfields="name" titlefield="name" minlength="1" searchstr="searchString"/>');
      $scope.selectedCountry = undefined;
      $scope.countries = [
        {name: 'Afghanistan', code: 'AF'},
        {name: 'Aland Islands', code: 'AX'},
  ...
  describe('processResults', function() {
    ...
    it('should set $scope.results[0].title', function() {
      var element = angular.element('<div angucomplete id="ex1" placeholder="Search names" selectedobject="selected" localdata="names" searchfields="name" titlefield="name" minlength="1" searchstr="searchString"/>');
      $compile(element)($scope);
      $scope.$digest();
    ...
    it('should set $scope.results[0].title for two title fields', function() {
      var element = angular.element('<div angucomplete id="ex1" placeholder="Search names" selectedobject="selected" localdata="names" searchfields="name" titlefield="firstName,lastName" minlength="1" searchstr="searchString"/>');
      $compile(element)($scope);
      $scope.$digest();
    ...
    it('should set $scope.results[0].description', function() {
      var element = angular.element('<div angucomplete id="ex1" placeholder="Search names" selectedobject="selected" localdata="names" searchfields="name" titlefield="name" descriptionfield="desc" minlength="1" searchstr="searchString"/>');
      $compile(element)($scope);
      $scope.$digest();
    ...
    it('should set $scope.results[0].image', function() {
      var element = angular.element('<div angucomplete id="ex1" placeholder="Search names" selectedobject="selected" localdata="names" searchfields="name" titlefield="name" imagefield="pic" minlength="1" searchstr="searchString"/>');
      $compile(element)($scope);
      $scope.$digest();
    ...
    it('should set $scope.results[0].image with uri', function() {
      var element = angular.element('<div angucomplete id="ex1" placeholder="Search names" selectedobject="selected" localdata="names" searchfields="name" titlefield="name" imageuri="http:localhost/images/" imagefield="pic" minlength="1" searchstr="searchString"/>');
      $compile(element)($scope);
      $scope.$digest();
  ...
  describe('searchTimerComplete', function() {
    ...
    describe('remote API', function() {
      ...
      it('should call $http with given url and param', inject(function($httpBackend) {
        var element = angular.element('<div angucomplete id="ex1" placeholder="Search names" selectedobject="selected" url="names?q=" searchfields="name" datafield="data" titlefield="name" minlength="1" searchstr="searchString"/>');
        $compile(element)($scope);
        $scope.$digest();
